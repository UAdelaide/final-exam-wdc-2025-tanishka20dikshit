...
VALUES ((SELECT dog_id FROM Dogs WHERE name = 'Max'),'2025-06-10 08:00:00',30,'Parklands','open'),
       ...
       ((SELECT dog_id FROM Dogs WHERE name = 'Bruno'),'06-10 10:30:00',50,'Grant Ave','accepted'),
       ((SELECT dog_id FROM Dogs WHERE name = 'coco'),'06-10 09:35:00',45,'Beachside Ave','accepted'),